...
Read-only current-month commission email for one staff member (change only `STAFF_NAME`). Known category IDs: Sharon `132264`, Ella `132225`, Lauren `132263`. Groups appear in the month of their last invoice; totals use full history from 1 May 2026.
