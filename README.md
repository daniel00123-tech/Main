...
The dashboard includes unallocated, historic, uninvoiced, and unactioned job KPIs plus current-month sales. Staff rows are ranked by fewest red KPIs, then fewest amber KPIs, then lowest open workload.
