...
class SafetyFilterTest(unittest.TestCase):
    ...
    def test_requires_recognized_sales_invoice_document_type(self) -> None:
        accepted_types = ("Invoice", "Sales Invoice", "SalesInvoice", "SI")
        rejected_types = ("Purchase Invoice", "Credit Invoice", "Order", "Quote", "")
...
class TempInvoiceNominalCorrectorTest(unittest.TestCase):
    ...
    def test_resolves_group_job_reference_before_updating(self) -> None:
        ...
        client = FakeBigChangeClient(
            ...
            group_jobs_by_id={"G1": [{"JobRef": "JOB-1"}]},
        )
    ...
    def test_accepts_tax_code_normalization_when_tax_rate_matches(self) -> None:
