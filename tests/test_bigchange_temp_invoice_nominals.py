...
class FakeBigChangeClient:
    def __init__(
        ...
        verified_line_overrides: list[dict[str, Any]] | None = None,
    ) -> None:
        self.rows = rows
            ...
            "FinancialLines": [
                {
                    ...
                    **(self.verified_line_overrides[index] if index < len(self.verified_line_overrides) else {}),
                }
...
class SafetyFilterTest(unittest.TestCase):
    ...
    def test_rejects_purchase_invoice_even_though_it_contains_invoice(self) -> None:
        for doc_type in ("Purchase Invoice", "Purchase Order", "Delivery Note", ""):
            with self.subTest(doc_type=doc_type):
                processable, _ = document_is_processable({"DocumentType": doc_type})
                self.assertFalse(processable)

    def test_accepts_recognised_sales_invoice_document_types(self) -> None:
...
class TempInvoiceNominalCorrectorTest(unittest.TestCase):
    ...
    def test_deduplicates_invoices_without_sync_rows_by_temp_reference(self) -> None:
        doc = {
            "DocId": "D1",
            "Reference": "TEMP-100",
            "DocumentType": "Invoice",
    ...
    def test_resolves_group_job_reference_before_rebuilding_invoice(self) -> None:
        doc = {
            "DocId": "D1",
            "Reference": "TEMP-100",
            "DocumentType": "Invoice",
        ...
        client = FakeBigChangeClient(
            ...
            docs_by_id={"D1": doc},
            jobs_by_id={},
            jobs_by_ref={"JOB-1": {"JobId": "J1", "Type": "Fire", "Description": "Call Out"}},
    ...
    def test_accepts_tax_code_normalisation_when_tax_rate_is_unchanged(self) -> None:
        doc = {
            "DocId": "D1",
            "Reference": "TEMP-100",
            "DocumentType": "Invoice",
        ...
        client = FakeBigChangeClient(
            ...
            docs_by_id={"D1": doc},
            jobs_by_id={"J1": {"JobId": "J1", "Type": "Fire", "Description": "Call Out"}},
            verified_line_overrides=[{"TaxCode": "20%", "TaxRate": "20"}],
        )
