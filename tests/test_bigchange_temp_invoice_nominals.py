...
class SafetyFilterTest(unittest.TestCase):
    ...
    def test_rejects_purchase_financial_documents(self) -> None:
...
class TempInvoiceNominalCorrectorTest(unittest.TestCase):
    ...
    def test_deduplicates_multiple_unsynced_rows_for_same_temp_reference(self) -> None:
        doc = {
            "DocId": "D1",
            "Reference": "TEMP-100",
            "DocumentType": "Invoice",
        ...
        client = FakeBigChangeClient(
            rows=[
                {"InvoiceType": "SI", "Reference": "TEMP-100", "Id": "row-1"},
                {"InvoiceType": "SI", "Reference": "TEMP-100", "Id": "row-2"},
            ],
            docs_by_ref={"TEMP-100": doc},
            docs_by_id={"D1": doc},
            jobs_by_id={"J1": {"JobId": "J1", "Type": "Fire Alarm", "Description": "Call Out fault"}},
    ...
    def test_resolves_group_job_by_reference_when_group_row_has_no_job_id(self) -> None:
        doc = {
            "DocId": "D1",
            "Reference": "TEMP-100",
            "DocumentType": "Invoice",
            ...
            "FinancialLines": [
                {
                    "Description": "Fire alarm service",
                    "UnitPrice": "100",
                    "Quantity": "1",
                    "TaxCode": "T1",
                    "TaxRate": "20",
