...
class SafetyFilterTest(unittest.TestCase):
    ...
    def test_rejects_invoice_like_non_sales_document_types(self) -> None:
        unsafe_types = ("Purchase Invoice", "Credit Invoice", "Sales Order", "Invoice Credit", "Quote", "")
    ...
    def test_accepts_only_recognizable_sales_invoice_document_types(self) -> None:
    ...
    def test_requires_document_type(self) -> None:
...
class TempInvoiceNominalCorrectorTest(unittest.TestCase):
    ...
    def test_resolves_group_job_reference_to_job_id_before_update(self) -> None:
        doc = {
            "DocId": "D1",
            "Reference": "TEMP-100",
            "DocumentType": "Invoice",
        ...
        client = FakeBigChangeClient(
            ...
            docs_by_id={"D1": doc},
            jobs_by_id={},
            jobs_by_ref={"JOB-1": {"JobId": "J1", "Type": "Fire", "Description": "PPM service"}},
    ...
    def test_verification_accepts_tax_code_normalisation_when_rate_matches(self) -> None:
        ...
        corrector.verify_document(verified_doc, [original_line], "2002")
