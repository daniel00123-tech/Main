...
class SafetyFilterTest(unittest.TestCase):
    ...
    def test_allows_bigchange_empty_date_sentinels(self) -> None:
        processable, reason = document_is_processable(
            {
                "DocumentType": "Invoice",
                "CancellationDate": "0001-01-01T00:00:00",
                "DeletionDate": "0001-01-01 00:00:00",
                "RejectionDate": "",
            }
        )
...
class TempInvoiceNominalCorrectorTest(unittest.TestCase):
    ...
    def test_processes_each_temp_reference_once(self) -> None:
        doc = {
            "DocId": "D1",
            "Reference": "TEMP-100",
            "DocumentType": "Invoice",
        ...
        client = FakeBigChangeClient(
            ...
            docs_by_ref={"TEMP-100": doc},
            docs_by_id={"D1": doc},
            jobs_by_id={"J1": {"JobId": "J1", "Type": "Electrical", "Description": "PPM"}},
        )
    ...
    def test_uses_first_group_job_when_document_has_no_direct_job(self) -> None:
        doc = {
            "DocId": "D1",
            "Reference": "TEMP-100",
            "DocumentType": "Invoice",
        ...
        client = FakeBigChangeClient(
            ...
            docs_by_ref={"TEMP-100": doc},
            docs_by_id={"D1": doc},
            jobs_by_id={"J2": {"JobId": "J2", "Type": "Fire", "Description": "PPM service"}},
