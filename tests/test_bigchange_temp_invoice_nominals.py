...
class TempInvoiceNominalCorrectorTest(unittest.TestCase):
    ...
    def test_deduplicates_invoice_rows_by_temp_reference(self) -> None:
        ...
        client = FakeBigChangeClient(
            rows=[
                {"InvoiceType": "SI", "Reference": "TEMP-100", "InvoiceId": "D1", "Id": "line-1"},
                {"InvoiceType": "SI", "Reference": "TEMP-100", "InvoiceId": "D1", "Id": "line-2"},
            ],
            docs_by_ref={"TEMP-100": doc},
            docs_by_id={"D1": doc},
    ...
    def test_verification_allows_tax_code_normalisation_when_rate_is_preserved(self) -> None:
        doc = {
            "DocId": "D1",
            "Reference": "TEMP-100",
            "DocumentType": "Invoice",
        ...
        client = FakeBigChangeClient(
            ...
            docs_by_id={"D1": doc},
            jobs_by_id={"J1": {"JobId": "J1", "Type": "Fire Alarm", "Description": "Call Out fault"}},
            verified_line_overrides=[{"TaxCode": "VAT20", "TaxRate": "20"}],
        )
