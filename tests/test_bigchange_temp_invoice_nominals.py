...
class FakeBigChangeClient:
    def __init__(
        ...
        self.verified_tax_code: str | None = None
            ...
            "FinancialLines": [
                {
                    ...
                    **({"TaxCode": self.verified_tax_code} if self.verified_tax_code is not None else {}),
                }
...
class SafetyFilterTest(unittest.TestCase):
    ...
    def test_rejects_non_invoice_document_types(self) -> None:
        blocked_types = ("Credit Note", "Purchase Invoice", "Purchase Order", "Quote")

        for doc_type in blocked_types:
...
class TempInvoiceNominalCorrectorTest(unittest.TestCase):
    ...
    def test_scans_duplicate_temp_rows_once_by_reference(self) -> None:
        doc = {
            "DocId": "D1",
            "Reference": "TEMP-100",
            "DocumentType": "Invoice",
            "JobId": "J1",
            "FinancialLines": [
                {"UnitPrice": "1", "Quantity": "1", "TaxRate": "20", "NominalCode": "2101"}
            ],
        }
        client = FakeBigChangeClient(
            rows=[
    ...
    def test_resolves_embedded_group_job_reference_before_update(self) -> None:
        doc = {
            ...
            "Reference": "TEMP-100",
            "DocumentType": "Invoice",
            "Group": {"Jobs": [{"JobReference": "JOB-1"}]},
            "FinancialLines": [
                {"UnitPrice": "1", "Quantity": "1", "TaxRate": "20", "NominalCode": "9999"}
            ],
        }
        client = FakeBigChangeClient(
            rows=[{"InvoiceType": "SI", "Reference": "TEMP-100", "InvoiceId": "D1"}],
    ...
    def test_allows_tax_code_normalization_when_tax_rate_is_unchanged(self) -> None:
        doc = {
            "DocId": "D1",
            "Reference": "TEMP-100",
            "DocumentType": "Invoice",
        ...
        client.verified_tax_code = "VAT20"
