...
class SafetyFilterTest(unittest.TestCase):
    ...
    def test_rejects_non_invoice_document_types(self) -> None:
        for doc_type in ("Credit Note", "Purchase Invoice", "Purchase Order"):
    ...
    def test_rejects_documents_without_type(self) -> None:
...
class TempInvoiceNominalCorrectorTest(unittest.TestCase):
    ...
    def test_de_duplicates_temp_invoice_rows_by_reference(self) -> None:
        doc = {
            "DocId": "D1",
            "Reference": "TEMP-100",
            "DocumentType": "Invoice",
        ...
        client = FakeBigChangeClient(
            ...
            docs_by_ref={"TEMP-100": doc},
            docs_by_id={"D1": doc},
            jobs_by_id={"J1": {"JobId": "J1", "Type": "Electrical", "Description": "Service PPM"}},
        )
    ...
    def test_resolves_group_job_reference_before_updating(self) -> None:
        doc = {
            "DocId": "D1",
            "Reference": "TEMP-100",
            "DocumentType": "Invoice",
        ...
        client = FakeBigChangeClient(
            ...
            docs_by_id={"D1": doc},
            jobs_by_id={},
            jobs_by_ref={"JOB-1": {"JobId": "J1", "Type": "Grounds", "Description": "Scheduled maintenance"}},
