...
class SafetyFilterTest(unittest.TestCase):
    ...
    def test_requires_recognizable_sales_invoice_document_type(self) -> None:
        accepted = ("Invoice", "Sales Invoice", "SalesInvoice", "SI")
        ...
        rejected = ("Purchase Invoice", "Sales Credit Note", "Purchase Order", "")
        for doc_type in rejected:
            with self.subTest(doc_type=doc_type):
...
class TempInvoiceNominalCorrectorTest(unittest.TestCase):
    ...
    def test_deduplicates_invoices_without_sync_rows_by_temp_reference(self) -> None:
        ...
        client = FakeBigChangeClient(
            rows=[
                {"InvoiceType": "SI", "Reference": "TEMP-100", "InvoiceId": "D1"},
                {"InvoiceType": "SI", "Reference": "TEMP-100", "InvoiceId": "D1-LINE-2"},
            ],
            docs_by_ref={"TEMP-100": doc},
            docs_by_id={"D1": doc},
            jobs_by_id={"J1": {"JobId": "J1", "Type": "Fire", "Description": "Call Out"}},
    ...
    def test_resolves_group_job_reference_before_updating_invoice(self) -> None:
        doc = {
            "DocId": "D1",
            "Reference": "TEMP-100",
            "DocumentType": "Invoice",
        ...
        client = FakeBigChangeClient(
            ...
            docs_by_id={"D1": doc},
            jobs_by_id={},
            jobs_by_ref={"JR-1": {"JobId": "J9", "JobRef": "JR-1", "Type": "Grounds", "Description": "Scheduled"}},
            group_jobs_by_id={"G1": [{"JobRef": "JR-1"}]},
        )
        ...
        self.assertEqual(report.failures, [])
        self.assertEqual(report.invoices_updated, 1)
        self.assertEqual(client.added_lines[0]["JobId"], "J9")
