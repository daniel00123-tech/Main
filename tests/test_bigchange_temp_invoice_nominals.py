...
class TempInvoiceNominalCorrectorTest(unittest.TestCase):
    ...
    def test_deduplicates_repeated_rows_by_temp_reference(self) -> None:
        doc = {
            "DocId": "D1",
            "Reference": "TEMP-100",
            "DocumentType": "Invoice",
    ...
    def test_resolves_group_job_summary_before_classification(self) -> None:
        doc = {
            "DocId": "D1",
            "Reference": "TEMP-100",
            "DocumentType": "Invoice",
        ...
        client = FakeBigChangeClient(
            ...
            docs_by_ref={"TEMP-100": doc},
            docs_by_id={"D1": doc},
            jobs_by_id={"J1": {"JobId": "J1", "Type": "Grounds", "Description": "Scheduled maintenance"}},
        ...
        self.assertEqual(report.invoices_updated, 1)
        self.assertEqual(report.lines_updated, 1)
        self.assertEqual(client.created_items[0]["NominalCode"], "2105")
