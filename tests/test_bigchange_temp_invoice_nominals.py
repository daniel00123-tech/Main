...
class TempInvoiceNominalCorrectorTest(unittest.TestCase):
    ...
    def test_resolves_first_group_job_by_reference_when_job_id_is_missing(self) -> None:
        doc = {
            "DocId": "D1",
            "Reference": "TEMP-100",
            "DocumentType": "Invoice",
        ...
        client = FakeBigChangeClient(
            ...
            docs_by_id={"D1": doc},
            jobs_by_id={},
            jobs_by_ref={"JOB-1": {"JobId": "J1", "Type": "Grounds", "Description": "Reactive repair"}},
        ...
        self.assertEqual(report.invoices_updated, 1)
        self.assertEqual(client.added_lines[0]["JobId"], "J1")
        self.assertEqual(client.added_lines[0]["NominalCode"], "2005")
