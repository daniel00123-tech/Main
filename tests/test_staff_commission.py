...
class LaurenCommissionTest(unittest.TestCase):
    def test_under_2000_earn_rates(self) -> None:
        sale = decimal.Decimal("1000")
        self.assertEqual(job_commission(sale, decimal.Decimal("750"), "Lauren"), decimal.Decimal("0"))
        self.assertEqual(job_commission(sale, decimal.Decimal("650"), "Lauren"), decimal.Decimal("3.50"))
        self.assertEqual(job_commission(sale, decimal.Decimal("550"), "Lauren"), decimal.Decimal("9.00"))
        self.assertEqual(job_commission(sale, decimal.Decimal("400"), "Lauren"), decimal.Decimal("18.00"))

    def test_mid_band_earn_rates(self) -> None:
        sale = decimal.Decimal("3000")
        self.assertEqual(job_commission(sale, decimal.Decimal("2400"), "Lauren"), decimal.Decimal("6.00"))
        self.assertEqual(job_commission(sale, decimal.Decimal("1900"), "Lauren"), decimal.Decimal("22.00"))
        self.assertEqual(job_commission(sale, decimal.Decimal("1600"), "Lauren"), decimal.Decimal("42.00"))

    def test_high_band_earn_rates(self) -> None:
        sale = decimal.Decimal("8000")
        self.assertEqual(job_commission(sale, decimal.Decimal("7000"), "Lauren"), decimal.Decimal("10.00"))
        self.assertEqual(job_commission(sale, decimal.Decimal("6000"), "Lauren"), decimal.Decimal("40.00"))
        self.assertEqual(job_commission(sale, decimal.Decimal("5000"), "Lauren"), decimal.Decimal("90.00"))

    def test_below_floor_stepped_by_sale(self) -> None:
        self.assertEqual(lauren_order_penalty(decimal.Decimal("499.99")), decimal.Decimal("-1.50"))
        self.assertEqual(lauren_order_penalty(decimal.Decimal("500")), decimal.Decimal("-5.00"))
        self.assertEqual(lauren_order_penalty(decimal.Decimal("1999.99")), decimal.Decimal("-5.00"))
        self.assertEqual(lauren_order_penalty(decimal.Decimal("2000")), decimal.Decimal("-10.00"))
        self.assertEqual(lauren_order_penalty(decimal.Decimal("4999.99")), decimal.Decimal("-10.00"))
        self.assertEqual(lauren_order_penalty(decimal.Decimal("5000")), decimal.Decimal("-25.00"))
        self.assertEqual(
            job_commission(decimal.Decimal("400"), decimal.Decimal("380"), "Lauren"),
            decimal.Decimal("-1.50"),
        )
        self.assertEqual(
            job_commission(decimal.Decimal("705"), decimal.Decimal("599.25"), "Lauren"),
            decimal.Decimal("-5.00"),
        )
        self.assertEqual(
            job_commission(decimal.Decimal("3000"), decimal.Decimal("2800"), "Lauren"),
            decimal.Decimal("-10.00"),
        )
        self.assertEqual(
            job_commission(decimal.Decimal("8000"), decimal.Decimal("7600"), "Lauren"),
            decimal.Decimal("-25.00"),
        )

    def test_po_only_uses_po_as_order_size(self) -> None:
        self.assertEqual(job_commission(decimal.Decimal("0"), decimal.Decimal("100"), "Lauren"), decimal.Decimal("-1.50"))
        self.assertEqual(job_commission(decimal.Decimal("0"), decimal.Decimal("500"), "Lauren"), decimal.Decimal("-5.00"))
        self.assertEqual(job_commission(decimal.Decimal("0"), decimal.Decimal("1999.99"), "Lauren"), decimal.Decimal("-5.00"))
        self.assertEqual(job_commission(decimal.Decimal("0"), decimal.Decimal("2000"), "Lauren"), decimal.Decimal("-10.00"))
        self.assertEqual(job_commission(decimal.Decimal("0"), decimal.Decimal("4999.99"), "Lauren"), decimal.Decimal("-10.00"))
        self.assertEqual(job_commission(decimal.Decimal("0"), decimal.Decimal("5000"), "Lauren"), decimal.Decimal("-25.00"))
        self.assertEqual(job_commission(decimal.Decimal("0"), decimal.Decimal("20000"), "Lauren"), decimal.Decimal("-25.00"))

    def test_uk_path_unchanged_without_staff_name(self) -> None:
        sale = decimal.Decimal("705")
        profit = sale * decimal.Decimal("0.15")
        po = sale - profit
        self.assertEqual(job_commission(sale, po), decimal.Decimal("-35.25"))
        self.assertEqual(job_commission(sale, po, "Sharon"), decimal.Decimal("-35.25"))
        self.assertEqual(job_commission(sale, po, "Lauren"), decimal.Decimal("-5.00"))

    def test_attach_commissions_uses_lauren_rates(self) -> None:
        rows = attach_commissions(
            [
                {
                    "date": dt.date(2026, 9, 2),
...
class AppearanceTest(unittest.TestCase):
    def test_known_category_map(self) -> None:
        ...
        self.assertEqual(TO_EMAIL, "william@elvexpropertyservices.com")
        self.assertEqual(CC_EMAIL, "william@elvexpropertyservices.com")
