...
class BaselineTest(unittest.TestCase):
    def test_build_report_sorts_staff_best_to_worst(self) -> None:
        ...
        client = FakeReportClient(
            categories=["Red Owner", "All Green", "Amber Owner", "Busy Amber"],
            jobs={
                "unallocated": [
                    {
                ...
                "unactioned": [
                    ...
                    },
                    {
                        ...
                        "StatusId": 12,
                        "ClientStatusId": -34,
                        "CompletedDate": (today - dt.timedelta(days=11)).isoformat(),
                        "Actioned": "No",
                    },
                ],
            },
        ...
        self.assertEqual(
            ...
            ["All Green", "Amber Owner", "Busy Amber", "Red Owner"],
        )

    def test_saves_requested_bigchange_kpi_baseline_fields(self) -> None:
        report = {
