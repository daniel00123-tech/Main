...
class SalesAttributionTest(unittest.TestCase):
    ...
    def test_calculates_invoice_net_from_common_line_shapes(self) -> None:
        ...
        self.assertEqual(sales["Amy Bradley"], 5)
...
class BaselineTest(unittest.TestCase):
    def test_saves_requested_baseline_fields(self) -> None:
        report = {
            "run_timestamp": "2026-07-13T07:00:00+00:00",
            "report_date": "2026-07-13",
            "job_lookback_start": "2025-07-13",
            "staff_rows": [
                {
        ...
        self.assertEqual(baseline["run_timestamp"], report["run_timestamp"])
        self.assertEqual(baseline["staff"][0]["staff_name"], "Amy Bradley")
        self.assertEqual(baseline["staff"][0]["counts"]["historic_jobs"], 1)
        self.assertEqual(baseline["staff"][0]["statuses"]["unactioned_jobs"], "red")
