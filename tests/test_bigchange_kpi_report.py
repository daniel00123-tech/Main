...
class CategoryExclusionTest(unittest.TestCase):
    ...
    def test_ignores_generic_job_id_and_name_when_resolving_category(self) -> None:
        row = {"Id": "42", "Name": "Amy Bradley"}

        self.assertEqual(job_category_name(row, {"42": "Amy Bradley"}), "")
