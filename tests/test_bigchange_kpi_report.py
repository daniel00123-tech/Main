...
class ScoreAndBaselineTest(unittest.TestCase):
    ...
    def test_sorts_staff_best_to_worst(self) -> None:
        today = dt.date.today()
        report = build_report(
            FakeReportBigChangeClient(
                categories=["All Green", "Green Workload", "Amber Staff", "Red Staff"],
                jobs=[
                    {
                        "CategoryName": "Green Workload",
                        "StatusId": 1,
                    ...
                    },
                    {
                        ...
                        "StatusId": 1,
                        "CreatedDate": (today - dt.timedelta(days=16)).isoformat(),
                    },
                    {
                        "CategoryName": "Red Staff",
                        "StatusId": 1,
                        "CreatedDate": (today - dt.timedelta(days=39)).isoformat(),
                    },
                ],
            )
        )
        ...
        self.assertEqual(
            ...
            ["All Green", "Green Workload", "Amber Staff", "Red Staff"],
        )
...
class FakeReportBigChangeClient:
    def __init__(self, categories, jobs) -> None:
