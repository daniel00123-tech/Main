...
class DashboardAndBaselineTest(unittest.TestCase):
    def test_renders_bigchange_only_dashboard_columns(self) -> None:
        report = {
        ...
        self.assertNotIn("good", dashboard.lower())
        self.assertNotIn("medium", dashboard.lower())
        self.assertNotIn("high", dashboard.lower())
