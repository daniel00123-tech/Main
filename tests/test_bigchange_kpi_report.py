...
class DashboardAndBaselineTest(unittest.TestCase):
    def test_rendered_dashboard_contains_requested_bigchange_columns_only(self) -> None:
        report = {
        ...
        self.assertIn("Unallocated Jobs", dashboard)
        self.assertIn("Historic Jobs", dashboard)
        self.assertIn("Uninvoiced Jobs", dashboard)
        self.assertIn("Unactioned Jobs", dashboard)
        self.assertIn("May sales", dashboard)
