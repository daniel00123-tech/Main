...
class ReportRankingAndBaselineTest(unittest.TestCase):
    def test_sorts_staff_by_fewest_reds_then_ambers_then_workload(self) -> None:
        ...
        self.assertEqual([row["staff_name"] for row in report["staff_rows"]], ["Clear Owner", "Amber Owner", "Red Owner"])
        self.assertEqual(report["staff_rows"][0]["red_kpis"], 0)
        self.assertEqual(report["staff_rows"][0]["amber_kpis"], 0)
        self.assertEqual(report["staff_rows"][1]["amber_kpis"], 1)
