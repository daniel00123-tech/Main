...
class CategoryExclusionTest(unittest.TestCase):
    ...
    def test_urban_report_must_use_urban_mailbox(self) -> None:
        validate_report_recipients("urban@nirvana-maintenance.co.uk", "daniel.dwyer@nirvana-group.co.uk")
        with self.assertRaises(ConfigError):
            validate_report_recipients("core@nirvana-maintenance.co.uk")
        with self.assertRaises(ConfigError):
            validate_report_recipients(
                "urban@nirvana-maintenance.co.uk",
