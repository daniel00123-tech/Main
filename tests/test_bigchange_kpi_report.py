...
class JobCategoryGroupingTest(unittest.TestCase):
    def test_groups_jobs_by_explicit_category_id_lookup_without_using_job_name(self) -> None:
        ...
        self.assertNotIn("Boiler repair", staff_names)
