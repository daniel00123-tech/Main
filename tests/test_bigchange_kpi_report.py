...
class RankingAndBaselineTest(unittest.TestCase):
    def test_ranks_staff_by_red_then_amber_then_workload(self) -> None:
        rows = [
            {"staff_name": "Amber Heavy", "red_kpis": 0, "amber_kpis": 2, "total_open_workload": 1},
            {"staff_name": "Red Light", "red_kpis": 1, "amber_kpis": 0, "total_open_workload": 0},
            {"staff_name": "All Green Busy", "red_kpis": 0, "amber_kpis": 0, "total_open_workload": 3},
        ...
        self.assertEqual(ordered, ["All Green Clear", "All Green Busy", "Amber Heavy", "Red Light"])

    def test_saves_baseline_with_requested_bigchange_fields(self) -> None:
        report = {
