...
class RankingAndBaselineTest(unittest.TestCase):
    def test_ranks_staff_by_red_amber_then_workload(self) -> None:
        rows = [
            {"staff_name": "High Workload", "red_kpis": 0, "amber_kpis": 1, "total_open_workload": 9},
            {"staff_name": "All Green", "red_kpis": 0, "amber_kpis": 0, "total_open_workload": 4},
            {"staff_name": "Red", "red_kpis": 1, "amber_kpis": 0, "total_open_workload": 0},
            {"staff_name": "Low Workload", "red_kpis": 0, "amber_kpis": 1, "total_open_workload": 2},
        ]

        rows.sort(key=ranking_key)

        self.assertEqual([row["staff_name"] for row in rows], ["All Green", "Low Workload", "High Workload", "Red"])
