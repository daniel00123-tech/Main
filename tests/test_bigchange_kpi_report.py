...
class RankingAndBaselineTest(unittest.TestCase):
    def test_ranks_staff_by_red_then_amber_then_workload(self) -> None:
        rows = [
            {"staff_name": "Charlie", "red_kpis": 1, "amber_kpis": 0, "total_open_workload": 1},
            {"staff_name": "Bravo", "red_kpis": 0, "amber_kpis": 1, "total_open_workload": 1},
            {"staff_name": "Alpha", "red_kpis": 0, "amber_kpis": 0, "total_open_workload": 3},
            {"staff_name": "Delta", "red_kpis": 0, "amber_kpis": 0, "total_open_workload": 1},
        ]

        ranked = sorted(rows, key=staff_ranking_key)

        self.assertEqual([row["staff_name"] for row in ranked], ["Delta", "Alpha", "Bravo", "Charlie"])

    def test_saves_baseline_with_requested_kpi_fields_only(self) -> None:
        report = {
    ...
    def test_html_uses_requested_bigchange_columns_only(self) -> None:
        report = {
            "run_timestamp": "2026-05-25T07:00:00+00:00",
            "report_date": "2026-05-25",
            "job_lookback_start": "2025-05-25",
            ...
            "staff_rows": [
                {
                    ...
                    "current_month_sales": 100.0,
                    "current_month_sales_display": "GBP 100.00",
                    "red_kpis": 0,
                    "amber_kpis": 0,
