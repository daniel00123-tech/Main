...
const token = `el_audit_${randomBytes(24).toString("hex")}`;
...
const res = await fetch("https://api.infrastack.app/api/internal/el-knowledge-onedrive-diagnostic", {
  method: "POST",
  headers: {
...
writeFileSync("/tmp/el-knowledge-onedrive-diagnostic.json", JSON.stringify(report, null, 2));
