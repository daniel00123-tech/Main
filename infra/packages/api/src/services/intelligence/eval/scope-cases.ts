...
const SEEDS: Seed[] = [
  ...
  { text: "What's the newest document in OneDrive?", scope: "COMPANY_KNOWLEDGE", tool: "list_documents" },
  { text: "Show me the latest ten files.", scope: "COMPANY_KNOWLEDGE", tool: "list_documents" },
  { text: "What was uploaded today?", scope: "COMPANY_KNOWLEDGE", tool: "list_documents" },
