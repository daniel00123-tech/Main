...
export async function ensureDefaultPricing(db: D1Database) {
  ...
  const defaults: Array<{
    ...
    {
      id: "price_xero_invoice_update",
      action: "xero.invoices.update",
      mode: "fixed",
      fixed: 1,
      billable: 1,
      label: "TEST: xero.invoices.update = 1p",
      min: 1,
    },
    {
      id: "price_xero_bill_approve",
      action: "xero.bills.approve",
      mode: "fixed",
      fixed: 1,
      billable: 1,
      label: "TEST: xero.bills.approve = 1p",
      min: 1,
    },
    {
      id: "price_xero_credit_note_create",
      action: "xero.credit_notes.create_draft",
      mode: "fixed",
      fixed: 1,
      billable: 1,
      label: "TEST: xero.credit_notes.create_draft = 1p",
      min: 1,
    },
    {
      id: "price_xero_credit_note_approve",
      action: "xero.credit_notes.approve",
      mode: "fixed",
      fixed: 1,
      billable: 1,
      label: "TEST: xero.credit_notes.approve = 1p",
      min: 1,
    },
    {
      id: "price_xero_credit_note_allocate",
      action: "xero.credit_notes.allocate",
      mode: "fixed",
      fixed: 1,
      billable: 1,
      label: "TEST: xero.credit_notes.allocate = 1p",
      min: 1,
    },
    {
      id: "price_xero_payment_allocate",
      action: "xero.payments.allocate",
      mode: "fixed",
      fixed: 1,
      billable: 1,
      label: "TEST: xero.payments.allocate = 1p",
      min: 1,
    },
    {
      id: "price_xero_contact_create",
      action: "xero.contacts.create",
      mode: "fixed",
      fixed: 1,
      billable: 1,
      label: "TEST: xero.contacts.create = 1p",
      min: 1,
    },
    {
      id: "price_xero_invoice_send",
      action: "xero.invoices.send",
      mode: "fixed",
      fixed: 1,
      billable: 1,
      label: "TEST: xero.invoices.send = 1p",
      min: 1,
    },
    {
      id: "price_xero_invoice_void",
      action: "xero.invoice.void",
      mode: "fixed",
      fixed: 1,
      billable: 1,
      label: "TEST: xero.invoice.void = 1p",
      min: 1,
    },
  ];
