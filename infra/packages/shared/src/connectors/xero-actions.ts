...
export const XERO_ACTIONS: XeroActionDefinition[] = [
  ...
  { action: "xero.invoice.void", riskClass: "delete", billingOperation: "xero.invoice.void", auditEvent: "xero.destructive_blocked", writesSupported: true, productionExecutable: false },
