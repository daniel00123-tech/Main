...
export const XERO_TOOL_CONTRACTS: XeroToolContract[] = [
  ...
  },
  {
    ...
    output: { invoices: "array", effectiveDate: "string", meta: "object" },
    implemented: true,
  ...
  },
  {
    ...
    output: { report: "object", byContact: "array", effectiveDate: "string", meta: "object" },
    implemented: true,
  ...
  {
    name: "xero.top_suppliers",
    action: "xero.top_suppliers",
    riskClass: "low_risk",
    billingOperation: "xero.top_suppliers",
    auditEvent: "mcp.execution_succeeded",
    input: { fromDate: "string?", toDate: "string?", limit: "number?" },
    output: { suppliers: "array", currencyCode: "string?", fromDate: "string", toDate: "string" },
    implemented: true,
    mcpToolName: "xero_top_suppliers",
  },
  {
    name: "xero.tax_rates.list",
    action: "xero.tax_rates.read",
    riskClass: "low_risk",
    billingOperation: "xero.tax_rates.read",
    auditEvent: "mcp.execution_succeeded",
    input: {},
    output: { taxRates: "array", capability: "object" },
    implemented: true,
    mcpToolName: "xero_list_tax_rates",
  },
  {
    name: "xero.vat.capability",
    action: "xero.vat.capability",
    riskClass: "low_risk",
    billingOperation: "xero.vat.capability",
    auditEvent: "mcp.execution_succeeded",
    input: {},
    output: { capability: "object" },
    implemented: true,
    mcpToolName: "xero_vat_capability",
  },
  {
    name: "xero.invoices.approve",
    action: "xero.invoices.approve",
    riskClass: "financial_action",
    billingOperation: "xero.invoices.approve",
    auditEvent: "xero.financial_action_executed",
    input: { invoiceId: "string" },
    output: { invoice: "object" },
    implemented: true,
    mcpToolName: "xero_approve_invoice",
    requiresWriteScopes: true,
    usesExecutionPlan: true,
  },
  {
    name: "xero.invoices.send",
    action: "xero.invoices.send",
    riskClass: "external_send",
    billingOperation: "xero.invoices.send",
    auditEvent: "xero.external_send_executed",
    input: { invoiceId: "string", emailAddress: "string?" },
    output: { invoice: "object" },
    implemented: true,
    mcpToolName: "xero_send_invoice",
    requiresWriteScopes: true,
    usesExecutionPlan: true,
  },
  {
    name: "xero.bills.create_draft",
    action: "xero.bills.create",
    riskClass: "financial_action",
    billingOperation: "xero.bills.create",
    auditEvent: "xero.financial_action_executed",
    input: { contactId: "string", lineItems: "array", reference: "string?" },
    output: { bill: "object" },
    implemented: true,
    mcpToolName: "xero_create_draft_bill",
    requiresWriteScopes: true,
    usesExecutionPlan: true,
  },
  {
    name: "xero.bills.approve",
    action: "xero.bills.approve",
    riskClass: "financial_action",
    billingOperation: "xero.bills.approve",
    auditEvent: "xero.financial_action_executed",
    input: { invoiceId: "string" },
    output: { bill: "object" },
    implemented: true,
    mcpToolName: "xero_approve_bill",
    requiresWriteScopes: true,
    usesExecutionPlan: true,
  },
  {
    name: "xero.credit_notes.create_draft",
    action: "xero.credit_notes.create_draft",
    riskClass: "financial_action",
    billingOperation: "xero.credit_notes.create_draft",
    auditEvent: "xero.financial_action_executed",
    input: { contactId: "string", lineItems: "array", reference: "string?" },
    output: { creditNote: "object" },
    implemented: true,
    mcpToolName: "xero_create_draft_credit_note",
    requiresWriteScopes: true,
    usesExecutionPlan: true,
  },
  {
    name: "xero.contacts.create",
    ...
    output: { contact: "object" },
    implemented: true,
    mcpToolName: "xero_create_contact",
    requiresWriteScopes: true,
    usesExecutionPlan: true,
  },
  {
