...
export const COMPANY_ROLE_PRESETS: RolePreset[] = [
  ...
  },
  {
    ...
    description:
      "Finance staff. Knowledge plus Xero and financial reads. No invoice approval or admin.",
    allowedActions: [
      "knowledge.search",
      "knowledge.read",
      "system.health",
  ...
  },
  {
    ...
    description: "Operations lead. Office-staff operational access plus sales reads.",
    allowedActions: [
      "knowledge.search",
      "knowledge.read",
      "system.health",
  ...
  },
  {
    ...
    description: "Finance lead. Xero reads and draft writes. No company admin.",
    allowedActions: [
      "knowledge.search",
      "knowledge.read",
      "system.health",
    ...
    deniedByDefault: ["xero.invoices.approve", "xero.bills.approve", "xero.invoices.send"],
  },
  {
    role: "supervisor",
