...
def render_html(report: dict[str, Any]) -> str:
    ...
    total_sales = format_currency(decimal.Decimal(str(sum(row["current_month_sales"] for row in report["staff_rows"]))))
    totals = {
...
<body>
  <main class="dashboard">
    ...
    <section class="total-cards">
      ...
      <div class="total-card"><span>{month_name} sales</span><strong>{html.escape(total_sales)}</strong></div>
    </section>
