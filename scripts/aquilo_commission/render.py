...
GROKBOT_QUOTES = (
    "You're not just closing jobs. You're collecting plot armour.",
    "Go on then — make this month blush.",
    "Hot tip from Grokbot: you are, in fact, that good.",
    "If motivation was a biscuit, this is the one with extra chocolate.",
    "The universe called. It wants a tidy finish and a little swagger.",
    "Be the reason the job list needs a lie-down.",
    "Today's forecast: 100% chance of you being slightly legendary.",
    "Your to-do list is not the boss of you. You are the boss of it. Nicely.",
    "One more good job and the month starts writing fan mail.",
    "Smile at the next job like it bought the teas. Then smash it.",
    "Confidence looks good on you. A completed job looks even better.",
    "May your coffee be strong and your comeback stronger.",
    "Doubt is just a badly written extra. Cut the scene and keep going.",
    "Grokbot checked the vibes. They're excellent. Don't waste them.",
    "Be the job you want to see in the world. Then tick it off with jazz hands.",
    "Little jobs, big energy. That's the whole personality.",
    "Your future self just sent a high five. Don't leave them hanging.",
    "Keep going. The numbers are just applause that arrives fashionably late.",
)
